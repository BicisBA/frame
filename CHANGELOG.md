...
## [2.11.0] - 2023-03-13
### Added
- Features from nearby stations

### Changed
- Dataset transformations as transformers for ease of use

## [2.10.1] - 2023-03-13
### Fixed
- Add `is_holiday` feature for predictions on API
...
## [2.9.2] - 2023-03-07
### Fixed
- Missing feature on predict

## [2.9.1] - 2023-03-07
### Fixed
- Migration on mlflow version

## [2.9.0] - 2023-03-07
### Added
- Caching in-memory or with redis

## [2.8.0] - 2023-03-06
### Changed
- ETA Query improved
- Added MAPE as ETA metric
- Removed ETA postprocessing
- Increased ETA estimators and changed to L1 regression

## [2.7.1] - 2023-03-05
### Fixed
- Double reloading time for models
- Allow to configure reloading times for API info and models

## [2.7.0] - 2023-03-05
### Added
- Persist features used for predictions to DB

## [2.6.0] - 2023-03-05
### Added
- Log estimator params to mlflow
